...
export default () => (
	<Page>
		...
		<div className="home">
			...
			<h3>Worship and Protect this Rock</h3>
		...
		<style jsx>{`
			...
			.earth:after {
				...
				box-shadow: 10px 50px 0 3px white, 50px -15px 0 2px white,
					...
					340px 130px 0 1px white, 400px 0px 0 0 white,
					410px 50px 0 3px white, 500px 25px 0 1px white,
					450px -15px 0 2px white, 470px 70px 0 -1px white,
					540px 75px 0 -3px white, 510px 105px 0 -4px white,
					650px -25px 0 -1px white, 610px 50px 0 1px white,
